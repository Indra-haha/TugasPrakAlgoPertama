...
int inputDataBuku(int n)
{
    ...
    do
    {
        ...
        cin.ignore();
        cin.getline(data[a].penerbit, 10);
...
int dataBuku()
{
    ...
    for (int b = 0; b < temp; b++)
    {
        for (int k = 0; k < 5; k++)
        {
            ...
            {
            case 0:
                cout << data[b].judul << setw(20 - strlen(data[b].judul)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 1:
                cout << data[b].pengarang << setw(18 - strlen(data[b].pengarang)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 2:
                cout << data[b].penerbit << setw(18 - strlen(data[b].penerbit)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 3:
                cout << data[b].terbit << setw(13 - (to_string(data[b].terbit)).size()) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 4:
                cout << data[b].harga << setw(13 - (to_string(data[b].harga)).size()) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            }
        }
        cout << endl;
...
int bubble_asc(int k, int temp)
{
    ...
    {
        strcpy(sementara[a].judul, data[a].judul);
        strcpy(sementara[a].pengarang, data[a].pengarang);
        strcpy(sementara[a].penerbit, data[a].penerbit);
    ...
    for (int i = 0; i < temp; i++)
    {
        for (int j = 0; j < 30; j++)
        {
            if (n == 1)
            {
                if (sementara[i].judul[j] > sementara[i + 1].judul[j])
                {
            ...
            {
                if (sementara[i].pengarang[j] > sementara[i + 1].pengarang[j])
                {
                    swap(sementara[i], sementara[i + 1]);
                }
                else
            ...
            {
                if (sementara[i].penerbit[j] > sementara[i + 1].penerbit[j])
                {
                    swap(sementara[i], sementara[i + 1]);
                }
                else
    ...
    for (int b = 0; b < temp; b++)
    {
        for (int k = 0; k < 5; k++)
        {
            ...
            {
            case 0:
                cout << sementara[b].judul << setw(20 - strlen(sementara[b].judul)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 1:
                cout << sementara[b].pengarang << setw(18 - strlen(sementara[b].pengarang)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 2:
                cout << sementara[b].penerbit << setw(18 - strlen(sementara[b].penerbit)) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 3:
                cout << sementara[b].terbit << setw(13 - (to_string(sementara[b].terbit)).size()) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            case 4:
                cout << sementara[b].harga << setw(13 - (to_string(sementara[b].harga)).size()) << setiosflags(ios::right) << "|" << setw(2) << setiosflags(ios::right) << " ";
                break;
            }
        }
        cout << endl;
